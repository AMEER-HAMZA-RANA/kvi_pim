...
if($catalog_id !== ''){
    ...
    $sku_marketing = get_post_meta($catalog_id, 'sku_marketing', true);
    $catalog_name = get_post_meta($catalog_id, 'catalog_name', true);
    $category_ids = get_post_meta($catalog_id, 'category_ids', true);
    $language = get_post_meta($catalog_id, 'language', true);
    $category_ids = explode(",", $category_ids);
    
    // echo "<pre>";
    // print_r($queue_working);
    // die();
...
<div class="catalogprice">
    ...
    <form id="main_form"  action="" method="post" enctype="multipart/form-data" >
        <div class="pagebody">
            <div class="headtxt">
                <h2>Price Book Export</h2>
                <p>
                    Price Books export allows you to generate csv or PDF files for specific products and/or pre-defined categories and associated Price Book(s).
                </p>
                <p>
                    CSV file export matches the Arrow Fastener “2022 Master Price List - Product Management 
                    Updated ” Excel file used by Arrow Fastener.
                </p>
            </div>
            <div class="rowFlex">
            ...
            <div class="books-sku-details" id="books-sku-details">
                <!-- sku pricing section -->
                <div class="sku-pricing my-4">
                    <div class="below-tb-head">
                        <h3>SKU Pricing</h3>
                    </div>
                    <div class="sku-description books-options">
                        <input type="radio" id="sku-pricing" name="attributes_sku" value="small" <?php echo $catalog_id !== '' && $sku_pricing == true ? "checked" : ""; ?>  >
                        <label for="sku-pricing">SKU Pricing will include product thumbnail, product title, product SKU and
                            price
                            from any combination of the Price Books.</label>
                    </div>
                </div>
                
                <!-- sku Marketing section -->
                <div class="sku-marketing my-4">
                    <div class="below-tb-head">
                        <h3>SKU Marketing</h3>
                    </div>
                    <div class="sku-description books-options">
                        <input type="radio" id="sku-marketing" name="attributes_sku" value="marketing" <?php echo $catalog_id !== '' && $sku_marketing == true ? "checked" : ""; ?>   >
                        <label for="sku-marketing">SKU Marketing will include Product Thumbnail, Product Title, Product SKU, Online Title, Online Description, Marketing Copy, Bullet 1, Bullet 2, Bullet 3, Bullet 4, Bullet 5, Bullet 6, Bullet 7, Bullet 8, Compatible Fasteners, Compatible Tools, Handle Type, Material Type, Primary Trade</label>
                    </div>
                    <div class="language ml-5">
                        <div class="options">
                            <input class="mr-3" type="radio" name="language" id="english" value='en' <?php echo $catalog_id !== '' && $language == 'en' ? "checked" : ""; ?> >
                            <Label for="english">English</Label>
                        </div>
                        <div class="options">
                            <input class="mr-3" type="radio" name="language" id="french" value='fr'  <?php echo $catalog_id !== '' && $language == 'fr' ? "checked" : ""; ?> >
                            <Label for="french">French</Label>
                        </div>
                        <div class="options">
                            <input class="mr-3" type="radio" name="language" id="spanish" value='sp'  <?php echo $catalog_id !== '' && $language == 'sp' ? "checked" : ""; ?> >
                ...
                <div class="sku-attributes">
                    ...
                    <div class="attri-description books-options">
                        <input type="radio" id="sku-attri" name="attributes_sku" value="large" <?php echo $catalog_id !== '' && $sku_attributes == true ? "checked" : ""; ?> >
                        <label for="sku-attri">SKU Attributes will include product thumbnail, product title, product SKU,
                            Pack
                            Quantity, Pack UPC, EAN, Pack Cube Quantity, Item Weight, Item Height, Item
                            Depth, Item Width, Inner Quantity, Inner UPC, Inner Weight, Inner Height, Inner
                            Width, Inner Depth, Inner Cube Quantity, Master Weight, Master Height, Master
                            Width, Master Depth, Master Cube, Unit Cube, Skid Quantity, Skid Layers, and Packaging
                            Zone.</label>
                    </div>
                </div>
                <!-- price & output -->
                <div class="price-output my-4">
                    ...
                    <div class="output">
                        ...
                        <div class="descriptiontxt">
                            <div class="desc-item">
                                <input type="radio" id="csv" name="output" value="csv" <?php echo $catalog_id !== '' && $output_type == 'CSV' ? "checked" : ""; ?> >
                                <label for="csv">CSV</label>
                            </div>
                            <div class="desc-item">
                                <input type="radio" id="pdf" name="output" value="pdf" <?php echo $catalog_id !== '' && $output_type == 'PDF' ? "checked" : ""; ?> >
                    ...
                    <div class="items">
                        ...
                        while ($query->have_posts()) {
                            ...
                            <div class="logo-options">
                                ...
                                <?php echo $catalog_id !== '' && isset( $customer_logo['ID']) && $customer_logo['ID'] == $thumbnail_url ? "checked" : ""; ?>
                                >
