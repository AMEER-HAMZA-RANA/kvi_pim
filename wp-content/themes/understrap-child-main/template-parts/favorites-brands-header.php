...
if(substr($user_roles,0,7)=="shopvac" && $brand->slug=='shopvac'){ ?>
												
												<div class="swiper-slide">
													<a class="<?php //echo $class;?>" href="<?php //echo home_url( '/'. $brand->slug.'/favorites' );?>">
														<img src="<?php //echo $options[$brand->brand_code.'_logo']['url'];?>" alt="">
													</a>
												</div>
												<?php //}else if(substr($user_roles,0,7)!="shopvac" && $brand->slug!='shopvac'){
											?>
												<div class="swiper-slide">
													<a class="<?php //echo $class;?>" href="<?php //echo home_url( '/'. $brand->slug.'/favorites' );?>">
														<img src="<?php //echo $options[$brand->brand_code.'_logo']['url'];?>" alt="">
