...
<h3 class="current-cat text-center pg-heading mt-5">ALL</h3>
<div class="loader">
  <svg class="" width="60" height="60" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function loadProductItems(limit, page, target = null, filter = 0) {
    ...
    return fetch('<?php echo admin_url("admin-ajax.php"); ?>', {
        ...
        body: new URLSearchParams({
          ...
          page,
          filter,
          action: 'fetch_product_items',
          // search: searchChars.length > 3 ? searchChars : '',
          ...
          _wpnonce: '<?php echo wp_create_nonce('fetch_product_items'); ?>'
        })
      })
  ...
  loadProductItems(28, 1, null, document.querySelector('.prods_filters').value);
  ...
  document.addEventListener('click', function(e) {
    ...
    if (e.target.closest('.product-items-count li')) {
      ...
      loadProductItems(limit, 1, e.target, document.querySelector('.prods_filters').value);
    ...
    if (e.target.closest('.page-item')) {
      ...
      const limit = document.querySelector('.product-items-count li.active').dataset.val;
      loadProductItems(limit, page, e.target, document.querySelector('.prods_filters').value);
    }
